...
// Generate simple golden reference for MaxPool
...
int main(int argc, char** argv) {
    ...
    // CMD 2: Compute MaxPool
    write_cmd(2, OP_FW_MAXPOOL, 0x10000000, 0x10000100, 0x10000200);
    ...
    if (success) {
        cout << "[TEST] MaxPool executed successfully." << endl;
