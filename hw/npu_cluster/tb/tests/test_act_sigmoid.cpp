...
int main(int argc, char** argv) {
    ...
    // Test Multiple Sizes for Sigmoid
    ...
    write_cmd(tb, cmd_base, 1, OP_COMPUTE_ACT_SIGMOID, 0x10000000, 0, 0x10000200);
    ...
    cout << "[TEST] Running Sigmoid Size 64..." << endl;
    ...
    cout << "[TEST] Sigmoid All Sizes PASSED!" << endl;
    return 0;
}
